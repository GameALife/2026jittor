...
class GCNNet(nn.Module):
    def __init__(self, num_features, num_classes, hidden_dim=256, dropout=0.8):
        ...
        # 定义两层 GCN 卷积层
        self.conv1 = GCNConv(in_channels=num_features, out_channels=hidden_dim, spmm=False)
        self.conv2 = GCNConv(in_channels=hidden_dim, out_channels=num_classes, spmm=False)
